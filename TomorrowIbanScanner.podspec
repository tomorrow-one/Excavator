...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TomorrowIbanScanner.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/PavelStepanovTomorrow/TomorrowIbanScanner'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'PavelStepanovTomorrow' => 'pavel@tomorrow.one' }
  s.source           = { :git => 'https://github.com/PavelStepanovTomorrow/TomorrowIbanScanner.git', :tag => s.version.to_s }
